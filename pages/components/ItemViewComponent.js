  ...
  return (
    <>
      ...
      {["variationPopup", "extraPopup", "addonPopup"].map((popup) => (
        <div
          key={popup}
          className={`modal-wrapper ${activePopup === popup ? "show" : "hide"}`}
          id={popup}
        >
          <div className="modal-box">
            <div className="modal-header">
              <h5 className="modal-title">{popup.replace("Popup", "")}</h5>
              <span className="modal-close" onClick={closePopup}>×</span>
            </div>
            ...
            <form className="modal-form">
              ...
              <div className="modal-actions">
                ...
                {popup === "extraPopup" && (
                  <button type="submit" onClick={handleSubmit1} className="btn btn-primary">
                    <i className="bi bi-check-circle-fill"></i> Save
                  </button>
                )}
              </div>
